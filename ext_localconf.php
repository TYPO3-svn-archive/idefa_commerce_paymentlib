...
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['commerce/pi3/class.tx_commerce_pi3.php']['init'][]		= 'EXT:idefa_commerce_paymentlib/class.tx_com_bridge_reorder.php:tx_com_bridge_reorder';
$GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['commerce/pi3/class.tx_commerce_pi3.php']['main'][]		= 'EXT:idefa_commerce_paymentlib/class.tx_com_bridge_reorder.php:tx_com_bridge_reorder';
